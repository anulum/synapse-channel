...
"""Parse the source-verified OpenCode 1.18.32 ``run --format json`` stream."""
...
OPENCODE_SCHEMA_VERSION = "1.18.32"
OPENCODE_SCHEMA_VERIFIED = True
"""True only for the source and real-process captured 1.18.32 emitter contract."""
