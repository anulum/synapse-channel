...
def _cmd_supervisor(
    ...
    *,
    ...
    supervisor = SupervisorWorker(
        ...
        predictive_stall=getattr(args, "predictive_stall", True),
        history_multiplier=getattr(args, "history_multiplier", 3.0),
        min_history_samples=getattr(args, "min_history_samples", 4),
        min_predictive_idle_seconds=getattr(args, "min_predictive_idle_seconds", 60.0),
