...
_RULES: dict[str, tuple[str, str, str, bool]] = {
    "install_synapse_package": ("package", "operator_confirmation", "environment_change", True),
    "select_supported_python": ("python", "operator_confirmation", "environment_change", True),
...
def load_setup_plan(path: str | Path) -> dict[str, object]:
    ...
    try:
        ...
        return validate_setup_plan(cast(dict[str, object], document))
...
def validate_setup_plan(document: dict[str, object]) -> dict[str, object]:
    ...
    try:
        ...
        validated_setup_target(document.get("target"))
...
def build_setup_authorization(
    ...
    *,
    ...
    restart_required = "operator_restart_authority" in authorities
    valid_pid = (
