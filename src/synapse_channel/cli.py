...
* ``review-feedback`` — bind and route independently decided review to its author;
...
_REGISTRATION_UNITS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("synapse_channel.cli_deliberate:add_parsers", ("deliberate",)),
    ...
    (
        "synapse_channel.cli_a2a:add_parsers",
        ("a2a-card", "a2a-serve", "a2a-interop-trace", "a2a-client"),
    ),
